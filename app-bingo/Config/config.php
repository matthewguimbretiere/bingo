...
define('APP_SRC_DIRECTORY', APP_ROOT_DIRECTORY . 'app-bingo' . DS);

/** chemin absolu vers le dossier des ressources CSS,JS,IMAGES */
define('APP_ASSETS_DIRECTORY', APP_ROOT_DIRECTORY . DS . 'www' . DS . 'bingo-h' . DS . 'assets' . DS);
...
define(
  ...
  (strpos($_SERVER['SERVER_PROTOCOL'], '80') ? 'http' : 'http') .
